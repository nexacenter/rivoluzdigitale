...
- [Parte di contenuti di alto livello](#parte-di-contenuti-di-alto-livello)
	...
	- [Tecnologie della comunicazione – parte preliminare (pre-Internet) (lezione 8)](#tecnologie-della-comunicazione-parte-preliminare-pre-internet-lezione-8)
		...
		- [La stampa](#la-stampa)
			...
			- [I primi editori](#i-primi-editori)
...
In questo contesto è stato effettuato uno studio molto ampio dal Congresso Americano negli anni 50 e successivamente riconfermato pochi anni fa. Machlup uno dei massimi esperti di brevetti è arrivato alla conclusione che non si riesce ad affermare che i brevetti siano effettivamente utili, ma dal momento che già sono usati, che esistono da secoli e che c'è tutta un'impalcatura costruita sopra, tanto vale tenerli.
...
I brevetti software hanno creato un clima di incertezza in cui capita che programmatori non sviluppino per paura di violare i brevetti di qualcuno, causando un effetto di autocensura. 
...
###Conclusioni lezione 5
	il web non è un Far West si lasciano molte più tracce che da qualsiasi altra parte
...
##La logica e il calcolatore universale (Lezione 13)
...
1. Potessimo liberarci dell'onere pesantissimo di fare calcoli (200 anni dopo Menabrea lo sapeva bene) e compie un ulteriore passo logico avanti. Consapevole che la calcolatrice può fare i calcoli, Leibniz pensa che se riuscissimo a rappresentare matematicamente e algebricamente il pensiero umano, ci potrebbe essere una macchina che ragiona automaticamente (passaggio dal calcolare al ragionare). In questo contesto viene introdotta la logica deduttiva. Inoltre Leibniz analizza i vantaggi del ragionare senza l'onere del calcolare (citazione 1 pag 27).

2. Fosse possibile catturare in maniera formale pensieri e ragionamento. Secondo Leibniz, formalizzando il pensiero sarebbe impossibile scrivere cose incoerenti. Per fare ciò bisognerebbe formalizzare l'intera conoscenza umana ed elaborarla tramite il *calculus razioniator*, il calcolo che ragiona, oppure l'algebra della logica. Per fare ciò secondo Leibniz servirebbero: 1) l'enciclopedia della conoscenza umana; 2) trovare il modo per trattare il pensero dal punto di vista logico; 3)uomini seri seduti intorno a un tavolo che possano formalizzare il pensiero, calcolarlo algebricamente e quindi ottenere un risultato sarà inoppugnabile.
...
Come molti sono consapevoli, ci sono diversi problemi che non si possono risolvere con i calcolatori elettronici. La tecnocrazia, tuttavia, è un concetto che è rinato dopo la II Guerra Mondiale e anche oggi continua a fiorire  (“per tutto c'è una soluzione tecnica”)

Leibniz compie un primo tentativo di matematizzare la logica di Aristotele (i sillogismi).

###George Boole e la logica
George Boole è conscio del fato che Leibniz avesse cercato di formalizzare il pensiero umano ma che non aveva concluso. 

Boole inizia a leggere fin da piccolo e si appassiona di libri, ma dato il loro costo, si appassiona in particolare di libri matematici in quanto duravano di più di un libro normale e così si specializzò. 

Boole è convinto dalla sua fede "Leibniziana" che sia possibile matematizzare i ragionamenti logici. Riprende gli studi di Leibniz e facendo un grosso passo avanti sviluppa l'algebra booleana, matematizza i ragionamenti tipo il sillogismo, e sfrutta il concetto di classi elaborato da Leibniz nella sua matematica. 
...
Il sistema di Boole abbraccia tutto Aristotele ma va ancora oltre riuscendo a dimostrare una volta per tutte che la deduzione logica poteva essere trattata come un ramo della matematica. Tutt'oggi la logica è trattata sia sotto il cappello della filosofia, che sotto quello della matematica.
...
Boole non fu un innovatore della logica, vennero tutti dopo di lui: tre grandi innovatori:
 ...
 5. Gödel, dottorando contemporaneo a Hilbert, dimostra che ciò che vuole fare Hilbert è impossibile. Nel 1931,  Gödel dimostra, attraverso il suo secondo teorema di incompletezza, che l'aritmetica non poteva essere usata per dimostrare la propria consistenza, e di conseguenza neppure la consistenza di teorie più complesse. Quindi anche il Principia Mathematica (il libro di Russel) non poteva dimostrare la coerenza della matematica. Dimostra che: 1) la pura e semplice coerenza di un sistema non garantisce che ciò che in esso viene dimostrato sia vero; 2) che ci possono essere proposizioni vere ma non dimostrabili all'interno del sistema.  
 6. John von Neumann, l'unico che capisce ciò che dice Gödel. Dopo aver parlato con lui smette di occuparsi di logica matematica fino ad occuparsi 10 anni dopo dei calcolatori elettronici.  
 7. Alan Turing, anche lui si occupa dei problemi di Hilbert e si applica alla strada algoritmica di Hilbert (citazione 6, p100).  

Strada algoritmica di Hilbert: ci sono delle premesse e una conclusione vera o falsa. Hilbert vuole arrivare a una soluzione usando un algoritmo per verificare se la conclusione sia vera o falsa date le premesse. Seguendo una serie di passi vorrebbe dimostrare tutta la conoscenza umana (seguendo il pensiero di Leibniz). Anche allora c'era scetticismo per un approccio del genere, se si riuscisse  a farlo non ci sarebbero più matematici.

###Alan Turing e il calcolatore universale
Turing adotta l'approccio algoritmico di Hilbert, pensando a come funziona la mente umana. Inizia con il domandarsi come un bambino apprenda le addizioni. Arriva a dedurre che il processo di apprendimento è costituito da singoli passi relativamente semplici. L'attenzione del calcolatore (essere umano) può essere su uno o al massimo due dati. Affinché il calcolo non venga sbagliato una persona può limitarsi a poche operazioni base. Queste operazioni base, secondo il pensiero di Turing, possono essere eseguite da una macchina. L'algoritmo può andare avanti all'infinito senza mai rivelarci sì la conclusione sia vera, oppure falsa. Turing non dice che non esiste la coerenza della matematica ma semplicemente che la soluzione algoritmica cicla all'infinito nel cercarla.

Turing arriva a dedurre una ipotetica macchina che ha in memoria un risultato parziale che legge nuovi numeri e li aggiunge/sottrae (o compie altre operazioni) a ciò che è in memoria.

Macchina di Turing: dato lo stato x, legge y, dunque decide cosa fare dopo.

Immagina una persona che esegua questi passi elementari. La macchina scrive una informazione su una casella (su un nastro con caselle) e decide se spostarsi a destra o a sinistra. Gli algoritmi realizzabili e adattabili a questa struttura molto semplice sono moltissimi. Il fatto che sia semplice la rende facile da analizzare, ha molta potenza. Tuttavia, la macchina di Turing, per quanto potente va avanti all'infinito cercando alcune soluzioni. Uno di questi casi è proprio quello che sta cercando Hilbert, cioè nel cercare la coerenza della matematica.

Il passo subito successivo è la macchina universale di Turing. Viene fatta l'assunzione che le informazioni lette possano essere sia dati che istruzioni per la macchina stessa (comandi, ciò che si vuole che la macchina faccia, cioè il software). Superamento della concezione hardware e software.

A questo livello si è ancora in ambito scientifico matematico ed è solo teorico. Solo durante la II Guerra Mondiale si arriva a pensare che si possano tradurre in pratica le idee di Turing.
La macchina non può dimostrare la coerenza del sistema matematico, ma potenzialmente può fare molte altre cose. Ciò rappresenta sconfitta per la matematica, ma in contemporanea si apre una nuova prospettiva:

	tutto ciò che è algoritmicamente solubile è risolvibile con una macchina.

Pochi anni dopo in Inghilterra negli USA e in Germania vengono creati I primi prototipi di calcolatori universali su questa idea. L'esigenza sociale sociale del calcolatore universale smuove ingentissimi finanziamenti che permetto di traslare il concetto teorico in pratica. 

La prima esigenza sono i computi balistici,le donne (erano donne coloro che solitamente svolgevano i calcoli) non erano più in grado di sviluppare sufficienti tabelle balistiche data l'enorme esigenza durante la Guerra Mondiale.
...
L'approccio da strumento fisico a servizio (così come  accade tra un libro fisico e avere in licenza un e-book) si può anche adottare per le macchine. Sempre più macchine hanno del software a bordo. Si crea così un interessante confine tra oggetto fisico e servizio in affitto. Ciò accade anche nell'ambito delle automobili e dei trattori - ad esempio General Motors e John Deere hanno sottomesso una richiesta ufficiale in cui chiedevano di non autorizzare l'accesso a bordo delle loro macchine e trattori secondo la legge sul diritto d'autore. 

Il Millemium Copyright Act vieta di entrare dentro nel software e eventualmente di “romperlo” anche se l'oggetto è di mia proprietà. Ad esempio è vietato "rompere" la crittografia di un DVD per estrarre il film. Analogamente il software all'interno di un trattore e di un automobile ha del software all'interno. La filosofia dietro è che con l'acquisto si compra la macchina, ma la parte software è solo data in licenza (l'auto è di proprietà ma il software no).

In ambito delle stampanti questo approccio è già adottato da tempo per fre funzionare il famoso modello di business *razor and blade*. In questo caso gli utenti non possono rompere il software che riconosce la cartuccia originale. La base legale per queste azioni è sempre la stessa.

###produzione tra pari - peer based production
Internet ha reso possibile la collaborazione con il fine di creare dei beni comuni.

I beni comuni a base di conoscenza creati in maniera collaborativa c'erano già prima di Internet. Un esempio è il grande dizionario della lingua inglese Oxford. La Oxford University Press fece un annuncio sul giornale per ottenere esempio di uso delle parole. Furono mandate cartoline da tutto l'impero inglese per creare gli esempi. Questa si può annoverare come prima forma di crowdsourcing. Come in ogni operazione di crowdsourcing, inoltre, un piccolo sottoinsieme di persone contribuì molto più degli altri. 
...
Storicamente solo una minoranza della popolazione poteva rivolgersi ad
...
il lettore che deve e vuole sapere da chi derivino certi ragionamenti (fonte: http://www.laprimaveradellascienza.it/due-righe-da-leggere-prima-di-qualunque-discussione/) .
...
4.  testimonianze di altri: ciò accade tutte le volte che affermiamo
    ...
    altri bisogna verificare l'affidabilità delle informazioni. Al
    giorno d’oggi su Internet (e in particolare sul web) il propagarsi
...
5.  opinioni argomentate: si tratta sostanzialmente di asserire
    ...
    delle proprie argomentazioni, che possono essere più o meno ampie
    e/o convincenti. 

Le argomentazioni sono basate su fonti. Le opinioni basate su
argomentazioni sono una sintesi delle fonti da cui sono state tratte
delle informazioni. Il lavoro di selezione e sintesi delle fonti non
finisce mai. La selezione delle fonti dovrebbe avvenire saggiando la
loro l'autorevolezza e l'affidabilità, incrociando informazioni diverse
e selezionando ad esempio elaborati di autori fidati.

Ogni giorno ci sono nuove fonti con cui raffinare le proprie
argomentazioni, ma la domanda "quanto devo prestare attenzione a questa
nuova fonte" è cruciale e richiede esperienza per essere affrontata.
L'università fa un po' questo lavoro, fornisce agli studenti
...
anche se codificate in modi diversi.

In un dibattito razionale la conoscenza scientifica ha molta importanza.
...
ancora oggi e si sbaglierà anche in futuro.

Essendo una conoscenza umana, è stata corrotta dalla politica, dalla
religione e ai giorni nostri soprattutto dal denaro. Ci sono studi su
studi deviati da finanziamenti che vogliono andare in una certa
predeterminata direzione.

Gli scienziati possono sbagliare, sono essere umani che come tutti noi
portano le loro passioni debolezze e codardie.

Tra gli esempi più eclatanti di studi scientifici deviati si può
annoverare il filone scientifico influenzato dall’eugenetica, in cui il
ragionamento e supposte prove scientifiche provavano come alcune persone
fossero inferiori ad altre. Ciò portò ad aberrazioni come la
sterilizzazione di determinate persone per evitare che esse si
propagassero.
...
Anche i fatti devono essere posti alla verifica della ragione. Capita
spesso di sentire frasi del tipo "discussione chiusa, questo è un
fatto", quando in realtà quel determinato fatto dovrebbe essere
verificato ulteriormente e vedere se effettivamente si tratti di un
fatto. Bisognerebbe innanzitutto verificare di che tipo di fatto si
tratti e di quanto esso sia discrezionale: è una legge di natura? È un
documento storico? Esistono testimoni oculari? Esistono prove
scientifiche?
...
insindacabile". Esattamente come per i fatti bisogna avere la capacità e
la competenza per dire da chi e come siano stati misurati, cosa
singifichino di preciso, se siano rappresentati correttamente, se siano
completi e se i confronti fatti siano equi. Molti grafici suggeriscono
...
ragione, il confronto e il metodo scientifico. E' uno spazio articolato
che va dal "molto probabilmente falso" o “poco probabilmente vero”, al
"molto probabilmente vero" noi di canto nostro dobbiamo decidere di chi
...
Questo è Il modo migliore di costruirsi una reputazione e, quindi, per
farsi ascoltare.

Su internet è facile comunicare, ma difficile farsi ascoltare: ci sono 2
miliardi  di concorrenti e presto 6. Per il lettore ogni istante ha un
valore infinito e la vita è una collezione finita di istanti, se
qualcosa non vale la pena di essere letto non sarà mai letto.

In fondo è per questo che siamo all'università, ci serve soprattutto per
capire come e dove prendere informazioni ma anche come argomentarle e
criticarle. Anche nel lavoro, in cui probabilmente si avrà un audience
...
istruzioni su come ci si iscrive ai vari social:
...
tuttavia si possono aprire blog anche con altri servizi o su propri
server personali.

Il processo di registrazione per creare un blog su Tumblr è piuttosto
standard. Vengono chiesti mail e password e bisogna accettare i soliti
“termini e condizioni”, che nessuno legge, ma in cui si accettano cose
che non si conoscono a cui saranno soggetti i sui contenuti futuri che
verranno pubblicati.

Solitamente viene anche chiesto di verificare la mail, onere a carico
...
Un modo per aggirare questo problema è usare Google. Nella schermata di “ricerca avanzata” di Google (raggiungibile attraverso un immagine di un ingranaggio in alto a destra nella finestra del broswer) è possibile specificare il dominio in cui cercare determinati messaggi, nel nostro caso basta specificare http://server-nexa.polito.it/pipermail/rd/ come dominio e la ricerca verrà effettuata solo negli archivi della mailing list ([a proposito della ricerca avanzata di Google e delle giovani generazioni](http://uk.businessinsider.com/millennials-dont-know-how-to-use-google-2015-5)). Inoltre si possono specificare altri filtri, ad esempio la lingua dei risultati. Tutti i flitri specificati nella maschera della ricerca avanzata di Google si ripercuoto sulla query che verrà prodotta e che verrà visualizzata nella barra di ricerca una volta effettuata la ricerca. Una scorciatoia per arrivare allo stesso risultato è digitare nella barra di ricerca di Google:
...
Il linguaggio audiovisivo è sempre più importante. Ora che ognuno può comunicarci attraverso e gli autori siamo noi (senza l'intervento di specialisti del settore), sia imprese che corsi a numero chiuso chiedono sempre di più una presentazione video del candidato.

Trend degli ultimi anni:
- Risoluzione dei video sempre maggiore
- Dai dispositivi mobili è facilissimo pubblicare un video
- Accesso a YouTube facilita la condivisione (ci vuole un account Google)

###Consigli pratici
Importante per pubblicare video per il corso:
- Privacy: pubblicare video con setting di privacy "non in elenco", attenzione a non metterlo “privato”, non sarà accessibile a nessuno tranne che al pubblicatore (quindi non potrà essere valutato)  
- Formato: registrare il video tenendo il cellulare (o un altro dispositivo di registrazione) in posizione orizzontale (modalità landscape)  
- Audio: occhio all'audio - non ci sono strumenti su YouTube per alzarlo
- Licenza: usare ai fini del corso la licenza Creative Commons (attribuzione – l'unica CC di YouTube).


###Ritocchi al video - Strumenti YouTube per migliorare il video
E' possibile apportare una serie di miglioramenti del video: luce, contrasto, saturazione, ritagliare il video (parte iniziale e parte finale).
Salvare il video prima di uscire sennò modifiche non rimangono.
E' inoltre disponibile un cursore per preferire audio o musica, modificarlo a piacimento ma tenendo sempre presente che si senta la voce di chi parla.
Oltre all'audio di sfondo si possono inserire una serie di elementi al video tipo fumetti titoli e nodi. Si può scegliere quando l'elemento grafico apparirà

Tutti questi tool sono presenti su YouTube di default, ma ce ne sono altri da usare su desktop più efficienti e con più opzioni.

	Reminder: settare nel tab il video su pubblico - un altro tab rispetto a quello della privacy

###Regole del video per il corso
...
2- settare la licenza: qualunque contenuto deve usare licenza creative commons per essere tutto in CC – chi non lo fa è penalizzato ai fini del corso

	per la valutazione: l'estro creativo se non inficia il contenuto è molto ben accetto

Contenuti: Descrivere prima se stessi e poi i contenuti del blog, non trascurare la parte su se stessi

Risorse audio in CC: lista di musiche in CC: su JAMENDO - oppure su Google filtrando risorse in CC

##Wikipedia (lezione 10)

Wikipedia nasce con l'idea di fornire accesso libero alla conoscenza umana – fino a pochi secoli fa era chiusa in monasteri e successivamente nei libri, ora grazie anche a Wikipedia è liberamente consultabile online.
Wikipiedia è una enciclopedia libera e collaborativa ed è basata (scritta e gestita) su una comunità di volontari che cambia nel tempo e che sono accomunati solo dalla voglia di contribuire

	“Immagina un mondo in cui ad ogni singola persona
	sul pianeta è dato libero accesso a tutto il patrimonio
	della conoscenza umana”

###5 pilastri di wikipedia
Wikipedia si basa sui seguenti 5 pilastri:
- Wikipedia è un'enciclopedia, non produce contenuti ma li riporta. se non c'è fonte viene riportato che bisogna migliorare la voce
- Wikipedia ha un punto di vista neutrale: devono esserci tutti i punti di vista
- Wikipedia è libera
- Wikipedia ha un codice di condotta: chi viola il codice viene anche bannato (in caso sia necessario)
...
Punto di forza: grandi numeri e diversità – maggiori sono i numeri maggiori sono punti di vista, la diversità più probabile nei grandi numeri.
C'è solo un piccolo inconveniente: su Wikipedia ci sono 80% maschi e 20% femmine, quindi c'è una maggioranza di contenuti di interesse maschili.

###Modificare le voci di Wikipedia
Per modificare il *wikitesto* si accede al codice della pagina che è simile tipo all'HTML oppure, su modifica semplice, si accede ad un editore tipo word "what you see is what you get"

###progetti fratelli 
- wikiquote: aforismi di persone importanti)
- wikisource: digitalizza libri di pubblico dominio e aggiunta informazioni tipo indice cliccabile e alte info (collegamenti ipertestuali)
- wikimedia commons: mette a disposizione file multimediali con licenza aperta tipo video, immagini ecc
- ...

###Conclusioni Wikipedia
